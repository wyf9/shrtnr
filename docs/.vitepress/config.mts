  ...
  nav: [
    ...
    { text: 'Contributing', link: '/contributing/guidelines' },
    {
      ...
      items: [
        ...
        { text: 'Upstream (oddbit/shrtnr)', link: 'https://github.com/oddbit/shrtnr' },
        { text: 'Changelog', link: 'https://github.com/wyf9/shrtnr/blob/main/CHANGELOG.md' },
      ],
    },
  ],
  sidebar: {
    ...
    '/integrations/': [
      {
        ...
        items: [
          ...
          { text: 'Browser Extensions', link: '/integrations/browser-extensions' },
        ],
      },
    ],
    '/api/': [
...
export default defineConfig({
  ...
  locales: {
    root: {
      ...
      lang: 'en-US',
      title: 'shrtnr',
      description: 'Self-hosted URL shortener on Cloudflare Workers + D1. Zero servers, zero monthly cost.',
    ...
    zh: {
      ...
      lang: 'zh-CN',
      title: 'shrtnr',
      description: '基于 Cloudflare Workers + D1 的自托管短链接服务。零服务器、零月费，数据完全归你所有。',
