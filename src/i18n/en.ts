...
const en = {
  ...
  "pages.empty": "No pages yet. Add one to start serving static content.",
  "pages.statusPlaceholder": "200",
  "pages.headersPlaceholder": "{}",

  // Client-side pages
  "client.pages.createTitle": "Create Page",
  "client.pages.editTitle": "Edit Page",
  "client.pages.slugLabel": "Slug *",
  "client.pages.filenameLabel": "Filename *",
  "client.pages.contentLabel": "Content *",
  "client.pages.httpStatusLabel": "HTTP Status",
  "client.pages.headersLabel": "Headers (JSON)",
  "client.pages.uploadFile": "Upload file to fill content",
  "client.pages.slugRequired": "Slug is required",
  "client.pages.filenameRequired": "Filename is required",
  "client.pages.contentRequired": "Content is required",
  "client.pages.created": "Page created",
  "client.pages.updated": "Page updated",
  "client.pages.createError": "Failed to create page",
  "client.pages.updateError": "Failed to update page",
  "client.pages.deleted": "Page deleted",
  "client.pages.deleteError": "Failed to delete page",
  "client.pages.disabledMsg": "Page disabled",
  "client.pages.enabled": "Page enabled",
  "client.pages.toggleError": "Failed to toggle page",
  "client.pages.confirmDelete": "Delete page /{slug}? This cannot be undone.",
