...
const en = {
  ...
  "bundles.introTitle": "A bundle is a collection of links.",
  "bundles.introBody": "Useful for tracking combined engagement on a project or campaign, like a blog post, GitHub repo, npm page, and docs link, all grouped under one open-source project. A link can belong to more than one bundle.",
  ...
  "settings.defaultRangeUnset": "Use last selection",
  "settings.defaultRangeHint": "Applied to the dashboard and link detail pages when no range is chosen.",
