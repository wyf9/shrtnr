...
const sv: Translations = {
  ...
  "pages.slugPlaceholder": "sido-slug",
  "pages.filenamePlaceholder": "index.html",
  "pages.add": "Lägg till sida",
  "pages.edit": "Redigera",
  "pages.delete": "Radera",
  ...
  // Client-side pages
  "client.pages.createTitle": "Skapa sida",
  "client.pages.editTitle": "Redigera sida",
  "client.pages.slugLabel": "Slug *",
  "client.pages.filenameLabel": "Filnamn *",
  "client.pages.contentLabel": "Innehåll *",
  "client.pages.httpStatusLabel": "HTTP-status",
  "client.pages.headersLabel": "Headers (JSON)",
  "client.pages.uploadFile": "Ladda upp fil för att fylla i innehåll",
  "client.pages.slugRequired": "Slug krävs",
  "client.pages.filenameRequired": "Filnamn krävs",
  "client.pages.contentRequired": "Innehåll krävs",
  "client.pages.created": "Sida skapad",
  "client.pages.updated": "Sida uppdaterad",
  "client.pages.createError": "Kunde inte skapa sida",
  "client.pages.updateError": "Kunde inte uppdatera sida",
  "client.pages.deleted": "Sida raderad",
  "client.pages.deleteError": "Kunde inte radera sida",
  "client.pages.disabledMsg": "Sida inaktiverad",
  "client.pages.enabled": "Sida aktiverad",
  "client.pages.toggleError": "Kunde inte ändra sidstatus",
  "client.pages.confirmDelete": "Radera sida /{slug}? Detta kan inte ångras.",
