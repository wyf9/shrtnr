...
const sv: Translations = {
  ...
  "bundles.introTitle": "En bunt är en samling länkar.",
  "bundles.introBody": "Användbart för att spåra kombinerat engagemang på ett projekt eller en kampanj, till exempel ett blogginlägg, GitHub-repo, npm-sida och dokumentationslänk, alla grupperade under ett öppen källkod-projekt. En länk kan tillhöra fler än en bunt.",
