...
const id: Translations = {
  ...
  "pages.slugPlaceholder": "slug-halaman",
  "pages.filenamePlaceholder": "index.html",
  "pages.add": "Tambah Halaman",
  "pages.edit": "Edit",
  "pages.delete": "Hapus",
  ...
  // Client-side pages
  "client.pages.createTitle": "Buat Halaman",
  "client.pages.editTitle": "Edit Halaman",
  "client.pages.slugLabel": "Slug *",
  "client.pages.filenameLabel": "Nama Berkas *",
  "client.pages.contentLabel": "Konten *",
  "client.pages.httpStatusLabel": "Status HTTP",
  "client.pages.headersLabel": "Headers (JSON)",
  "client.pages.uploadFile": "Unggah berkas untuk mengisi konten",
  "client.pages.slugRequired": "Slug diperlukan",
  "client.pages.filenameRequired": "Nama berkas diperlukan",
  "client.pages.contentRequired": "Konten diperlukan",
  "client.pages.created": "Halaman dibuat",
  "client.pages.updated": "Halaman diperbarui",
  "client.pages.createError": "Gagal membuat halaman",
  "client.pages.updateError": "Gagal memperbarui halaman",
  "client.pages.deleted": "Halaman dihapus",
  "client.pages.deleteError": "Gagal menghapus halaman",
