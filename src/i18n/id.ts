...
const id: Translations = {
  ...
  "bundles.introTitle": "Bundel adalah kumpulan tautan.",
  "bundles.introBody": "Berguna untuk melacak keterlibatan gabungan pada proyek atau kampanye, seperti postingan blog, repo GitHub, halaman npm, dan dokumentasi, semua dikelompokkan dalam satu proyek sumber terbuka. Sebuah tautan dapat berada di lebih dari satu bundel.",
  ...
  "settings.defaultRangeUnset": "Gunakan pilihan terakhir",
  "settings.defaultRangeHint": "Diterapkan di dasbor dan halaman detail tautan ketika tidak ada rentang yang dipilih.",
