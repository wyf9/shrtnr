...
export const themes = {
  ...
  light: {
    ...
    "--brand-surface-2": "#edf3f1",
    "--brand-accent": "#ff7637",
    "--brand-accent-soft": "#ff9061",
    "--brand-positive": "#a7e3a1",
    "--brand-info": "#a4e4ff",
    "--brand-neutral": "#09322f",
    "--brand-danger": "#c42b2b",

    /* semantic */
    "--color-canvas": "#f9fcfb",
    "--color-surface": "#ffffff",
    "--color-surface-raised": "#f3f8f6",
    "--color-surface-interactive": "#eaf3f0",

    "--color-text": "#12312e",
    "--color-text-muted": "#53706d",
    "--color-text-subtle": "#7a9290",
    "--color-text-inverse": "#ffffff",

    "--color-border": "#d7e4e0",
    "--color-border-strong": "#bfd3cd",
    ...
    "--color-success": "#a7e3a1",
    "--color-success-foreground": "#12312e",

    "--color-danger": "#c42b2b",
    "--color-danger-foreground": "#ffffff",

    "--color-info": "#a4e4ff",
    "--color-info-foreground": "#12312e",

    "--color-focus-ring": "#4fb9e8",
    "--color-selection": "rgba(255, 118, 55, 0.16)",

    "--color-disabled-bg": "#eef3f2",
    "--color-disabled-text": "#8aa09d",

    "--shadow-color": "rgba(9, 50, 47, 0.08)",
  },
} as const;
...
.detail-hero-side { display: flex; align-items: stretch; padding: 0; border-left: 1px solid var(--color-border); min-width: 480px; }
...
.detail-info-item.full-width { grid-column: span 2; border-bottom: 1px solid var(--color-border); padding-bottom: 0.75rem; }
...
.detail-short-url { font-family: var(--font-family-display); font-size: 1.75rem; font-weight: 700; color: var(--color-accent); word-break: break-all; }
...
@media (max-width: 768px) {
  ...
  .detail-hero-config { border-left: none; border-top: 1px solid var(--color-border); padding: 1.25rem 0 0; min-width: 0; }
